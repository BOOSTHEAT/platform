...
using ImpliciX.TimeCapsule.Tests;

namespace ImpliciX.Data.Tests.HotTimeSeries.Model
{
    ...
    public static class DefinedTestMetrics
    {
        public static readonly Metric<MetricUrn> PublicStateMetric1 =
        ...
        public static readonly Metric<MetricUrn> PublicStateMetric2 =
            new (MetricKind.State,
        ...
        public static readonly Metric<MetricUrn> GaugeMetric1 =
        ...
        public static readonly Metric<MetricUrn> VariationMetric1 =
        ...
        public static readonly Metric<MetricUrn> AccumulatorMetric1 =
            new (MetricKind.SampleAccumulator,
                fake_analytics.heating,
                fake_analytics.heating,
                fake_model.supply_temperature.measure,
                TimeSpan.FromDays(1));
