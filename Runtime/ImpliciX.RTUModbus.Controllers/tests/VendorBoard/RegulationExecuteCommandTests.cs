...
public class VendorBoardRegulationExecuteCommandTests
{
        ...
        public void should_send_communication_occured_fatal_and_a_property_changed_indicating_the_status_of_the_command_when_execution_fails()
        {
            ...
            var expectedEvents = new DomainEvent[]
            {
                SlaveCommunicationOccured.CreateFatal(test_model.software.fake_other_board, TimeSpan.Zero, Error_CommunicationDetails), 
